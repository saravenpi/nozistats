...
request.post(process.env.DEPLOYHOOK, {
  "headers":{
    'Content-Type': 'application/json'
  },
  "body": JSON.stringify({

  "username": "Heroku Deploy",
  "content": "Your code has been automatically pulled from github, and has beend deployed to heroku, find your app here: [https://noziro.herokuapp.com]"
