...
require("./render/stats")(app, hour, total)
require("./render/schedulesim")(app, total, hour)
require("./render/gettoken")(app, rp, cors, bodyParser)
require("./render/gettokenwithquery")(app, rp, cors, bodyParser)
