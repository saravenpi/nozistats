...
app.get("/gettoken", function(req,res) {
  ...
  app.post("/gettoken", function(req, res) {
    ...
    console.log(req.body.password + req.body.email)
      ...
      var options = {
    body: JSON.stringify({"email": req.body.email,"password": req.body.password,"undelete":false,"captcha_key":null,"login_source":null,"gift_code_sku_id":null, "captcha_key:" null"),
    headers: {
